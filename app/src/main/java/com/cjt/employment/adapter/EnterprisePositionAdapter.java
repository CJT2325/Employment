 ...
 * 邮箱: 445263848@qq.com.
 */
public class EnterprisePositionAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    private Context mContext;
    private OnItemClickListener listener;

    private List<EnterprisePosition.DataBean> datas;


    public void updataRecruit(List<EnterprisePosition.DataBean> data) {
        this.datas.clear();
        this.datas = data;
    ...
    public EnterprisePositionAdapter(List<EnterprisePosition.DataBean> datas, Context mContext, OnItemClickListener listener) {
        this.datas = datas;
...
//        Picasso.with(mContext).load(ServerAPI.baseUrl+datas.get(position).getStore().getStoreImage().getShopFile().getUrl()).resize(100, 100).into(holder.iv_shopcover);
    ...
    class RecruitmentViewHolder extends RecyclerView.ViewHolder implements View.OnClickListener {
        private EnterprisePositionAdapter.OnItemClickListener listener;
        ImageView iv_cover;
        ...
        public RecruitmentViewHolder(View itemView, EnterprisePositionAdapter.OnItemClickListener listener) {
            super(itemView);
