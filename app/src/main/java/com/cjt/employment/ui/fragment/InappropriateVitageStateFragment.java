...
import com.cjt.employment.presenter.InappropriateVitageStatePresenter;
import com.cjt.employment.ui.view.AllVitageStateView;

import java.util.ArrayList;
import java.util.List;

public class InappropriateVitageStateFragment extends BaseFragment<InappropriateVitageStateFragment, InappropriateVitageStatePresenter> implements AllVitageStateView {
    private ProgressBar progressbar;
    private RecyclerView mRecyclerView;
    private List<VitageStateBean.DataBean> mDatas;
    private VitageStateAdapter mVitageStateAdapter;

    public static InappropriateVitageStateFragment newInstance() {
        InappropriateVitageStateFragment fragment = new InappropriateVitageStateFragment();
    ...
    public InappropriateVitageStateFragment() {

    }

    @Override
    protected InappropriateVitageStatePresenter creatPresenter() {
        Log.i("CJT","创建AllVitagePresenter");
        return new InappropriateVitageStatePresenter(this);
    }
...
//        getPresenter().getRecruit("getAllUserVitage", Config.getValueByKey(getContext(),Config.KEY_USERID));
    ...
    public void onStart() {
        ...
        if (getPresenter() != null) {
            getPresenter().getAllStateVitage("getAllStateVitage", Config.getValueByKey(getContext(),Config.KEY_USERID),"3");
