...
import com.cjt.employment.presenter.UntreatedVitageStatePresenter;
import com.cjt.employment.ui.view.AllVitageStateView;

import java.util.ArrayList;
import java.util.List;

public class UntreatedVitageStateFragment extends BaseFragment<UntreatedVitageStateFragment, UntreatedVitageStatePresenter> implements AllVitageStateView {
    private ProgressBar progressbar;
    private RecyclerView mRecyclerView;
    private List<VitageStateBean.DataBean> mDatas;
    private VitageStateAdapter mVitageStateAdapter;

    public static UntreatedVitageStateFragment newInstance() {
        UntreatedVitageStateFragment fragment = new UntreatedVitageStateFragment();
    ...
    public UntreatedVitageStateFragment() {

    }

    @Override
    protected UntreatedVitageStatePresenter creatPresenter() {
        Log.i("CJT","创建AllVitagePresenter");
        return new UntreatedVitageStatePresenter(this);
    }
...
//        getPresenter().getRecruit("getAllUserVitage", Config.getValueByKey(getContext(),Config.KEY_USERID));
    ...
    public void onStart() {
        ...
        if (getPresenter() != null) {
            getPresenter().getAllStateVitage("getAllStateVitage", Config.getValueByKey(getContext(),Config.KEY_USERID),"0");
