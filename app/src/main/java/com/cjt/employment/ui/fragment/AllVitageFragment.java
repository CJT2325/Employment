...
public class AllVitageFragment extends BaseFragment<AllVitageFragment, AllVitagePresenter> implements AllVitageView {
    private ProgressBar progressbar;
    private RecyclerView mRecyclerView;
    private List<UserVitage.DataBean> mDatas;
    private UserVitageAdapter mUserVitageAdapter;

    public static AllVitageFragment newInstance() {
        AllVitageFragment fragment = new AllVitageFragment();
    ...
    public AllVitageFragment() {

    }

    @Override
    protected AllVitagePresenter creatPresenter() {
        Log.i("CJT","创建AllVitagePresenter");
        return new AllVitagePresenter(this);
