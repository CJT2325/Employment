...
public class AllVitageStateFragment extends BaseFragment<AllVitageStateFragment, AllVitageStatePresenter> implements AllVitageStateView {
    private ProgressBar progressbar;
    private RecyclerView mRecyclerView;
    private List<VitageStateBean.DataBean> mDatas;
    private VitageStateAdapter mVitageStateAdapter;

    public static AllVitageStateFragment newInstance() {
        AllVitageStateFragment fragment = new AllVitageStateFragment();
    ...
    public AllVitageStateFragment() {

    }

    @Override
    protected AllVitageStatePresenter creatPresenter() {
        Log.i("CJT","创建AllVitagePresenter");
        return new AllVitageStatePresenter(this);
    }
