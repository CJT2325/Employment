 ...
 * 邮箱: 445263848@qq.com.
 */
public class InterviewVitageStatePresenter extends BasePresenter<InterviewVitageStateFragment> {
    private AllVitageStateModel mAllVitageStateModel;
    private AllVitageStateView mAllVitageStateView;

    public InterviewVitageStatePresenter(AllVitageStateView allVitageStateView) {
