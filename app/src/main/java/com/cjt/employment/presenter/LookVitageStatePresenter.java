 ...
 * 邮箱: 445263848@qq.com.
 */
public class LookVitageStatePresenter extends BasePresenter<LookVitageStateFragment> {
    private AllVitageStateModel mAllVitageStateModel;
    private AllVitageStateView mAllVitageStateView;

    public LookVitageStatePresenter(AllVitageStateView allVitageStateView) {
