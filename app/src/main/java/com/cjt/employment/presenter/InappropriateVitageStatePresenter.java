 ...
 * 邮箱: 445263848@qq.com.
 */
public class InappropriateVitageStatePresenter extends BasePresenter<InappropriateVitageStateFragment> {
    private AllVitageStateModel mAllVitageStateModel;
    private AllVitageStateView mAllVitageStateView;

    public InappropriateVitageStatePresenter(AllVitageStateView allVitageStateView) {
