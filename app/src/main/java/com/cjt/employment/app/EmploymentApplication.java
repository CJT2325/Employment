package com.cjt.employment.app;
...
import com.cjt.employment.common.SystemUitl;
 ...
 * 邮箱: 445263848@qq.com.
 */
public class EmploymentApplication extends Application {
    @Override
    public void onCreate() {
        ...
        if (SystemUitl.inMainProcess(this)) {
            // 初始化UIKit模块
            initUIKit();
//        // ... your codes
//        if (inMainProcess()) {
...
//        ContactHelper.init();
    ...
    private LoginInfo getLoginInfo() {
        String account = Config.getUserAccount();
